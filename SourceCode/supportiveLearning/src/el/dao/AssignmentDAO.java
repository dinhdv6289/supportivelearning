...
//    }
   ...
   public ArrayList<Assignment> getListAssignmentsByBatchIdNotUse(int batchId) throws Exception {
        ArrayList<Assignment> assignments = new ArrayList<Assignment>();

        Connection conn = null;
        String sql = "{call Sel_AllAssignmentNotUse (?)}";
        try {
            conn = getConnection();
            CallableStatement cstmt = null;
 ...
 public ArrayList<Assignment> getListAssignmentsByBatchIdWork(int batchId) throws Exception {
        ArrayList<Assignment> assignments = new ArrayList<Assignment>();

        Connection conn = null;
        String sql = "{call Sel_AllAssignmentsWork (?)}";
        try {
            conn = getConnection();
            CallableStatement cstmt = null;
