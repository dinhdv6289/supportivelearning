...
(function( jQuery )
{
    ...
    jQuery.extend(Wysiwyg, {
        insertImage : function( szURL, attributes )
        {
            ...
            {
                if (jQuery.browser.msie) self.focus();
                if ( attributes )
                {
        ...
        TOOLBAR : {
            ...
            h1mozilla : { visible : true && jQuery.browser.mozilla, className : 'h1', command : 'heading', arguments : ['h1'], tags : ['h1'], tooltip : "Header 1" },
            h2mozilla : { visible : true && jQuery.browser.mozilla, className : 'h2', command : 'heading', arguments : ['h2'], tags : ['h2'], tooltip : "Header 2" },
            h3mozilla : { visible : true && jQuery.browser.mozilla, className : 'h3', command : 'heading', arguments : ['h3'], tags : ['h3'], tooltip : "Header 3" },

            h1 : { visible : true && !( jQuery.browser.mozilla ), className : 'h1', command : 'formatBlock', arguments : ['<H1>'], tags : ['h1'], tooltip : "Header 1" },
            h2 : { visible : true && !( jQuery.browser.mozilla ), className : 'h2', command : 'formatBlock', arguments : ['<H2>'], tags : ['h2'], tooltip : "Header 2" },
            h3 : { visible : true && !( jQuery.browser.mozilla ), className : 'h3', command : 'formatBlock', arguments : ['<H3>'], tags : ['h3'], tooltip : "Header 3" },
            ...
            separator08 : { separator : false && !( jQuery.browser.msie ) },

            increaseFontSize : { visible : false && !( jQuery.browser.msie ), tags : ['big'], tooltip : "Increase font size" },
            decreaseFontSize : { visible : false && !( jQuery.browser.msie ), tags : ['small'], tooltip : "Decrease font size" },
            ...
            removeFormat : {
                ...
                exec    : function()
                {
                    if (jQuery.browser.msie) this.focus();
    ...
    jQuery.extend(Wysiwyg.prototype,
    {
        ...
        focus : function()
        {
            jQuery(this.editorDoc.body).focus();
        },
        ...
        init : function( element, options )
        {
            ...
            if ( element.nodeName.toLowerCase() == 'textarea' )
            {
                ...
                var editor = this.editor = jQuery('<iframe src="javascript:false;"></iframe>').css({
                 ...
                 */
                this.editor.attr('tabindex', jQuery(element).attr('tabindex'));
            ...
            var panel = this.panel = jQuery('<ul role="menu" class="panel"></ul>');
        ...
        appendMenu : function( cmd, args, className, fn, tooltip )
        {
            ...
            jQuery('<li></li>').append(
                jQuery('<a role="menuitem" tabindex="-1" href="javascript:;">' + (className || cmd) + '</a>')
        ...
        {
            jQuery('<li role="separator" class="separator"></li>').appendTo( this.panel );
        },
