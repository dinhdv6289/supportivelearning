	     ...
	     *           node:nPaging - the DIV which contains this pagination control
			...
			"fnUpdate": function ( oSettings, fnCallbackDraw )
			{
				...
				for ( i=0, iLen=an.length ; i<iLen ; i++ )
				{
					...
					jQuery('span', nPaginateList).click( fnClick ).bind( 'mousedown', fnFalse )
	...
	jQuery.fn.dataTable = function( oInit )
	{
		...
		function _fnDrawHead( oSettings )
		{
			...
			if ( oSettings.oFeatures.bSort )
			{
				...
				jQuery('th', oSettings.nTHead).mousedown( function (e) {
		...
		function _fnDraw( oSettings )
		{
			...
			if ( typeof oSettings._bInitComplete == "undefined" )
			{
				...
				if ( oSettings.nTableWrapper != oSettings.nTable.parentNode &&
					jQuery(oSettings.nTableWrapper).width() > jQuery(oSettings.nTable.parentNode).width() )
				{
					_fnAjustColumnSizing( oSettings );
				}
		...
		function _fnScrollDraw ( o )
		{
			...
			nScrollHeadTable.style.width = _fnStringToCss( jQuery(o.nTable).outerWidth() );
			nScrollHeadInner.style.width = _fnStringToCss( jQuery(o.nTable).outerWidth()+o.oScroll.iBarWidth );
		...
		function _fnUpdateInfo ( oSettings )
		{
			...
			var jqFirst = jQuery(oSettings.aanFeatures.i[0]);
			var
