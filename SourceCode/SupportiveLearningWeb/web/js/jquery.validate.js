 ...
 *
 * jQueryId: jquery.validate.js 6403 2009-06-17 14:27:16Z joern.zaefferer jQuery
 *
...
jQuery.extend(jQuery.validator, {
	...
	defaults: {
		...
		groups: {},
		rules: {},
		errorClass: "error_small",
		validClass: "valid_small",
		errorElement: "label",
		focusInvalid: true,
				...
				jQuery.ajax(jQuery.extend(true, {
					...
					success: function(response) {
						...
						if ( valid ) {
							...
							errors[element.name] = jQuery.isFunction(message) ? message(value) : message;
